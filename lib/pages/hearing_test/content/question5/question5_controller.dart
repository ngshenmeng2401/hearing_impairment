...
class Question5Controller extends GetxController{
  ...
  final List<String> answer = ["Shake","Sad","Shape","Shade"];
  ...
  void storeAnswer(value) {
    ...
    userData.write("result5", result);
  }

  void loadAnswer(){

    selectAnswer = (userData.read("answer5")??'');
  }
