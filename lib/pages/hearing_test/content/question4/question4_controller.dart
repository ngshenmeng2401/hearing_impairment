...
class Question4Controller extends GetxController{

  final userData = GetStorage();
  AssetsAudioPlayer audioPlayer = AssetsAudioPlayer(); 
  bool showPlay = true, result = false;
  
  final List<String> answer = ["Play games","Drawing","Listening to music","Sleep"];
  ...
  void storeAnswer(value) {
    ...
    userData.write("result4", result);
  }

  void loadAnswer(){

    selectAnswer = (userData.read("answer4")??'');
  }
  ...
  void navigateToQuestion5(){
    
    Get.offNamed(AppRoutes.Question5Page);
  }
