...
class ForthQuestionView extends GetView<Question4Controller> {
  const ForthQuestionView({ Key? key }) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children:  [
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: GetBuilder<Question4Controller>(
                      init: Question4Controller(),
                      builder: (controller) {
                        return IconButton(
                          onPressed: (){
              ...
              const Text("Which one is not the hobby of Steven?"),
              Container(
                ...
                child: Column(
                  children: [
                    GetBuilder<Question4Controller>(
                      init: Question4Controller(),
                      builder: (controller) {
                        return ListTile(
                          title: const Text("a. Play games"),
                          trailing: Radio(
                    ...
                    GetBuilder<Question4Controller>(
                      ...
                      builder: (controller) {
                        return ListTile(
                          title: const Text("c. Listening to music"),
                          trailing: Radio(
