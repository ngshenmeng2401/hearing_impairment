...
class Question6Controller extends GetxController{

  final userData = GetStorage();
  AssetsAudioPlayer audioPlayer = AssetsAudioPlayer(); 
  bool showPlay = true, result = false;
  
  final List<String> answer = ["John","Sam","Sandra","Kendra"];
  ...
  void storeAnswer(value) {
    ...
    userData.write("result6", result);
  }

  void loadAnswer(){

    selectAnswer = (userData.read("answer6")??'');
  }
